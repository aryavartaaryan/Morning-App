...
export const DARK_BG_KEYS  = ['night', 'night_early', 'night_early_mid1', 'night_early_mid2', 'night_early_mid2_late', 'brahma', 'predawn', 'predawn_mid', 'twilight', 'twilight_late', 'twilight_deep', 'evening_early', 'evening', 'night_late'];
