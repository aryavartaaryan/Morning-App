...
const FALLBACK = {
  ...
  headline: 'Naad Reminder', subhead: 'Your Ayurvedic day needs you',
  message: 'Open the app to log your habits and stay aligned with your Dinacharya.',
  ctaLabel: 'Open Naad →', speechKey: ''
};
    ...
    <View style={s.root}>
      ...
      <SafeAreaView style={s.safe}>
        <Animated.View style={[s.content, { opacity: fadeAnim, transform: [{ scale: scaleAnim }] }]}>
          ...
          {/* ── Brand footer ── */}
          <Text style={s.footer}>Naad · Rise with the sun · Dinacharya System · Ayurvedic Intelligence</Text>
          <View style={{ height: 8 }} />
        </Animated.View>
      </SafeAreaView>
    </View>
