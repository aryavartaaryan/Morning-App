...
const FALLBACK = {
  ...
  headline: 'Nada Reminder', subhead: 'Your Ayurvedic day needs you',
  message: 'Open the app to log your habits and stay aligned with your Dinacharya.',
  ctaLabel: 'Open Nada →', speechKey: ''
};
    ...
    <View style={s.root}>
      ...
      <SafeAreaView style={s.safe}>
        <Animated.View style={[s.content, { opacity: fadeAnim, transform: [{ scale: scaleAnim }] }]}>
          ...
          {/* ── Brand footer ── */}
          <Text style={s.footer}>Nada · Rise with the sun · Dinacharya System · Ayurvedic Intelligence</Text>
          <View style={{ height: 8 }} />
        </Animated.View>
      </SafeAreaView>
    </View>
