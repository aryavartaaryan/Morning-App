...
const ALARM_SOUNDS = [
  ...
  { id: 'med_om_chanting_new',            label: 'Om Chanting (Cosmic Sound)',    emoji: '🕉️', cat: 'Mantra', color: '#6366f1', audioUrl: 'https://audio.onesutralabs.com/om.mp3' as string | null },
  { id: 'med_tanpura_new',                label: 'Tanpura (Nada Sound)',          emoji: '🎵', cat: 'Mantra', color: '#818cf8', audioUrl: 'https://audio.onesutralabs.com/Tanpura.mp3' as string | null },
...
const S = StyleSheet.create({
  ...
  alarmCard2: { marginHorizontal: 'auto', width: '90%', borderRadius: 24, overflow: 'hidden', borderWidth: 1, borderColor: 'rgba(255,255,255,0.15)', backgroundColor: 'rgba(255,255,255,0.05)', shadowColor: '#000', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.3, shadowRadius: 20, elevation: 10, marginBottom: 14 },
