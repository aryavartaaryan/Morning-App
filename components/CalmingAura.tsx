            ...
            <Svg height="600" width="600">
              <Defs>
                <RadialGradient id="bot1" cx="50%" cy="50%" r="50%">
                  <Stop offset="0" stopColor={isYantra ? "#FDE68A" : "#38BDF8"} stopOpacity={isYantra ? "0.2" : "0.6"} />
                  <Stop offset="0.55" stopColor={isYantra ? "#C9A24B" : "#818CF8"} stopOpacity={isYantra ? "0.1" : "0.3"} />
            ...
            <Svg height="600" width="600">
              <Defs>
                <RadialGradient id="bot2" cx="50%" cy="50%" r="50%">
                  <Stop offset="0" stopColor={isYantra ? "#F59E0B" : "#A78BFA"} stopOpacity={isYantra ? "0.2" : "0.5"} />
                  <Stop offset="0.55" stopColor={isYantra ? "#C1652F" : "#D8B4FE"} stopOpacity={isYantra ? "0.1" : "0.2"} />
                  <Stop offset="1" stopColor="#000000" stopOpacity="0" />
                </RadialGradient>
              </Defs>
