    ...
    <Modal visible={visible} animationType="none" transparent onRequestClose={onClose}>
      ...
      <Animated.View style={[S.sheet, { transform: [{ translateY: slideAnim }] }]}>
        ...
        <SafeAreaView style={{ flex: 1 }}>
          ...
          {/* ── Two-panel layout: left pills + right sounds ─────────────── */}
          <View style={{ flex: 1, flexDirection: 'row' }}>
            {/* Left: Collection pills */}
            <ScrollView
              style={S.leftCol}
            ...
            {/* Right: Sound list for active collection */}
              ...
              {activeGroup ? (
                <>
                  ...
                  <View style={S.rightHeader}>
                    ...
                    <View style={{ flex: 1 }}>
                      <Text style={[S.rightHeaderTitle, { color: activeGroup.themeColor }]} numberOfLines={1}>
                        {activeGroup.title}
                      </Text>
                ...
                <View style={S.emptyState}>
                  ...
                  <Text style={S.emptyStateDesc}>Tap any collection on the left to explore its sounds</Text>
                </View>
              )}
            </View>
          </View>
